...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyqtree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11168&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyqtree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyqtree` can be installed with:

```
conda install pyqtree
```

It is possible to list all of the versions of `pyqtree` available on your platform with:
